/*
  ...
  gengetopt -i comparator.ggo --file-name=comparator_cmdline --include-getopt --default-optional --unamed-opts
...
const char *gengetopt_args_info_purpose = "compare outputs of barriers and RNAlocmin";

const char *gengetopt_args_info_usage = "Usage: comparator [OPTIONS]... [FILES]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -b, --barriers=STRING   barriers file  (default=`barriers.out')",
  "  -l, --rnalocmin=STRING  RNAlocmin file  (default=`rnalocmin.out')",
  "      --open_barr         Returns open chain number in barriers  (default=off)",
  "      --open_loc          Returns open chain number in RNAlocmin  (default=off)",
  "  -o, --output=STRING     Output file name (default to stdout)",
  "  -v, --verbose           Display more things  (default=off)",
    0
};
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->barriers_given = 0 ;
  args_info->rnalocmin_given = 0 ;
  args_info->open_barr_given = 0 ;
  args_info->open_loc_given = 0 ;
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->barriers_arg = gengetopt_strdup ("barriers.out");
  args_info->barriers_orig = NULL;
  args_info->rnalocmin_arg = gengetopt_strdup ("rnalocmin.out");
  args_info->rnalocmin_orig = NULL;
  args_info->open_barr_flag = 0;
  args_info->open_loc_flag = 0;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->barriers_help = gengetopt_args_info_help[2] ;
  args_info->rnalocmin_help = gengetopt_args_info_help[3] ;
  args_info->open_barr_help = gengetopt_args_info_help[4] ;
  args_info->open_loc_help = gengetopt_args_info_help[5] ;
...
{
  unsigned int i;
  free_string_field (&(args_info->barriers_arg));
  free_string_field (&(args_info->barriers_orig));
  free_string_field (&(args_info->rnalocmin_arg));
  free_string_field (&(args_info->rnalocmin_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->barriers_given)
    write_into_file(outfile, "barriers", args_info->barriers_orig, 0);
  if (args_info->rnalocmin_given)
    write_into_file(outfile, "rnalocmin", args_info->rnalocmin_orig, 0);
  if (args_info->open_barr_given)
    write_into_file(outfile, "open_barr", 0, 0 );
  if (args_info->open_loc_given)
    write_into_file(outfile, "open_loc", 0, 0 );
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVb:l:o:v", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'b':	/* barriers file.  */
        
        
          if (update_arg( (void *)&(args_info->barriers_arg), 
               &(args_info->barriers_orig), &(args_info->barriers_given),
              &(local_args_info.barriers_given), optarg, 0, "barriers.out", ARG_STRING,
          ...
          break;
        case 'l':	/* RNAlocmin file.  */
        
        
          if (update_arg( (void *)&(args_info->rnalocmin_arg), 
               &(args_info->rnalocmin_orig), &(args_info->rnalocmin_given),
              &(local_args_info.rnalocmin_given), optarg, 0, "rnalocmin.out", ARG_STRING,
              check_ambiguity, override, 0, 0,
              "rnalocmin", 'l',
              additional_error))
            goto failure;
          ...
          break;
        case 'o':	/* Output file name (default to stdout).  */
        ...
        case 0:	/* Long option with no short option */
          /* Returns open chain number in barriers.  */
          if (strcmp (long_options[option_index].name, "open_barr") == 0)
          {
          
          
            if (update_arg((void *)&(args_info->open_barr_flag), 0, &(args_info->open_barr_given),
                &(local_args_info.open_barr_given), optarg, 0, 0, ARG_FLAG,
                check_ambiguity, override, 1, 0, "open_barr", '-',
                additional_error))
              goto failure;
          
          }
          /* Returns open chain number in RNAlocmin.  */
          else if (strcmp (long_options[option_index].name, "open_loc") == 0)
          {
          
          
            if (update_arg((void *)&(args_info->open_loc_flag), 0, &(args_info->open_loc_given),
                &(local_args_info.open_loc_given), optarg, 0, 0, ARG_FLAG,
                check_ambiguity, override, 1, 0, "open_loc", '-',
                additional_error))
              goto failure;
